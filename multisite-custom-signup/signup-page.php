...
if ( !is_main_site() ) {
	wp_redirect( network_site_url( 'get-your-own-blog/' ) );
	die();
}
...
function signup_another_blog( $blogname = '', $blog_title = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action="./get-your-own-blog/">
...
function signup_user( $user_name = '', $user_email = '', $errors = '' ) {
	...
	<form id="setupform" method="post" action="wp-signup.php" novalidate="novalidate">
		...
		<?php
		/** This action is documented in wp-signup/ */
...
if ( $active_signup == 'none' ) {
	...
	$login_url = wp_login_url( network_site_url( 'get-your-own-blog/' ) );
